...
Mʏ Nᴀᴍᴇ Is <a href=https://t.me/{}>{}</b></a>

ɪ ᴀᴍ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ɪɴꜰᴏʜᴜʙ ɴᴇᴛᴡᴏʀᴋꜱ.\nʏᴏᴜ ᴀʀᴇ ꜰʀᴇᴇ ᴛᴏ ᴜꜱᴇ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ.\n\nʜᴏᴡᴇᴠᴇʀ, ᴅᴏ ɴᴏᴛ ᴜꜱᴇ ᴍᴇ ꜰᴏʀ ɴꜱꜰᴡ ᴘᴜʀᴘᴏꜱᴇꜱ ᴏʀ ᴇʟꜱᴇ, ɪ ᴡɪʟʟ ʟᴇᴀᴠᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ꜰᴏʀᴇᴠᴇʀ. 

ᴘᴏᴡᴇʀᴇᴅ ʙʏ : <a href=https://t.me/infohub_updates>ɪɴꜰᴏʜᴜʙ ᴜᴘᴅᴀᴛᴇꜱ</a>"""
    
    HELP_TXT = """<b>ʜᴇʏ {},
ᴡᴇ ʜᴀᴠᴇ ᴅɪᴠɪᴅᴇᴅ ᴛʜᴇ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ ᴇᴀᴄʜ ꜰᴏʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀꜱ ᴀɴᴅ ʙᴏᴛ ᴜꜱᴇʀꜱ.</b>"""
...
‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ4.2 [sᴛᴀʙʟᴇ]</b>"""
    ...
    SOURCE_TXT = """<b>ɴᴏᴛᴇ: ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ɴᴏᴛ ᴀɴ ᴏᴘᴇɴ ꜱᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ.
Sᴏᴜʀᴄᴇ Cᴏᴅᴇ: <a href=https:/t.me/infohub_updates>ɪɴꜰᴏʜᴜʙ ᴜᴘᴅᴀᴛᴇꜱ</a>
Dᴇᴠᴇʟᴏᴘᴇʀ: <a href=https://t.me/the_universal_being>ᏰᎧᎧᏦᏇᎧᏒᎷ</a></b>"""
...
BOT {}"""
    ...
    ALRT_TXT = """{},
ᴛʜɪꜱ ᴍᴏᴠɪᴇ ʜᴀꜱ ʙᴇᴇɴ ʀᴇQᴜᴇꜱᴛᴇᴅ ʙʏ ꜱᴏᴍᴇᴏɴᴇ ᴇʟꜱᴇ. ʀᴇQᴜᴇꜱᴛ ʏᴏᴜʀꜱ ᴛᴏ ᴜꜱᴇ ᴍᴇ. 💁"""

    OLD_ALRT_TXT = """ᴛʜᴇ ᴍᴇꜱꜱᴀɢᴇ ʜᴀꜱ ᴇxᴘɪʀᴇᴅ. ᴘʟᴇᴀꜱᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ! 🤣."""

    CUDNT_FND = """<i>ɪ ɢᴜᴇꜱꜱ, ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪꜱ ᴡʀᴏɴɢ ᴏʀ ɪɴᴄᴏʀʀᴇᴄᴛ.
ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ᴀʀᴇ ᴀ ꜰᴇᴡ ᴍᴏᴠɪᴇꜱ ᴏʀ ᴡᴇʙꜱᴇʀɪᴇꜱ, 
ᴛᴀᴘ ᴏɴ ᴛʜᴇ ʀᴇꜱᴜʟᴛ ᴛʜᴀᴛ ʙᴇꜱᴛ ᴍᴀᴛᴄʜᴇꜱ ʏᴏᴜʀ ꜱᴇᴀʀᴄʜ!</i>"""

    I_CUDNT = """<b><i>ᴛʜᴇ ɴᴀᴍᴇ ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ, ᴅᴏᴇꜱ ɴᴏᴛ ᴍᴀᴛᴄʜ ᴀɴʏ ᴍᴏᴠɪᴇꜱ ᴏʀ ꜱᴇʀɪᴇꜱ,,
ᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ ꜰʀᴏᴍ ɢᴏᴏɢʟᴇ.</i> 👇👇</b>"""

    I_CUD_NT = """ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}.
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""

    MVE_NT_FND = """<i>ᴡᴇ ᴄᴏᴜʟᴅ ɴᴏᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ᴡɪᴛʜ ᴛʜɪꜱ ɴᴀᴍᴇ. 🙅,
    
ᴛʜɪꜱ ɴᴀᴍᴇ ʜᴀꜱ ʙᴇᴇɴ ꜰᴏʀᴡᴀʀᴅᴇᴅ ᴛᴏ ᴛʜᴇ ᴅᴇᴅɪᴄᴀᴛᴇᴅ ᴀᴅᴍɪɴꜱ ᴛᴇᴀᴍ

ᴛʜᴇ ᴍᴏᴍᴇɴᴛ ᴛʜᴇ ꜰɪʟᴍ ɪꜱ ᴜᴘʟᴏᴀᴅᴇᴅ, ᴡᴇ ᴡɪʟʟ ʟᴇᴛ ʏᴏᴜ ᴋɴᴏᴡ!</i>..."""

    TOP_ALRT_MSG = """ꜱᴇᴀʀᴄʜɪɴɢ ꜰᴏʀ ᴛʜᴇ ʀᴇꜱᴏᴜʀᴄᴇ 🔍..."""
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : <a href=https://t.me/the_universal_being>ᏰᎧᎧᏦᏇᎧᏒᎷ</a>
• ᴜꜱᴇʀɴᴀᴍᴇ : @the_universal_being
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href=https://t.me/the_universal_being>ᏰᎧᎧᏦᏇᎧᏒᎷ</a>"""
...
💵 ᴜᴘɪ ɪᴅ - <code>rajsom8877@oksbi</code>
📸 ǫʀ ᴄᴏᴅᴇ - <a href='https://envs.sh/wLE.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>

‼️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴘᴀʏᴍᴇɴᴛ.</b>"""

    UPI_TXT = """<b>
⚜️ ᴘᴀʏ ᴀᴍᴏᴜɴᴛ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ᴘʟᴀɴ ᴀɴᴅ ᴇɴᴊᴏʏ ᴘʀᴇᴍɪᴜᴍ ʙᴇɴᴇꜰɪᴛꜱ !
